...
angular.module('mean.system')
  .controller('IndexController', ['$scope', '$http', '$filter', '$sce', 'leafletData', 'projectSearch', 'projectConstants', '$rootScope', 'CookieService', 'Ags',
    function ($scope, $http, $filter, $sce, leafletData, projectSearch, projectConstants, $rootScope, CookieService, Ags) {
    // $scope.global = Global;
    var scope = $rootScope;
